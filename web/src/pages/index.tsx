                  ...
                  <div className="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 sm:text-center lg:px-0 lg:text-left lg:flex lg:items-center">
                    <div className="lg:py-24">
                      ...
                      <p className="text-base text-gray-300 sm:text-xl lg:text-lg xl:text-xl">
                        Aprenda programação através de cursos práticos com muito código e domine
                        as tecnologias do seu dia-a-dia.
                      </p>
                    </div>
                  </div>
                    ...
                    <blockquote>
                      <div>
                        ...
                        <p className="mt-6 text-2xl font-medium text-white">
                          Depois que eu comecei a estudar nessa plataforma eu consegui assumir
                          meus próprios projetos pessoais, trabalhar na empresa dos meus sonhos
                          e avistar os próximos passos da minha carreira.
                        </p>
                      </div>
